...
indexPairs = matchFeatures(features1, features2, 'MaxRatio', 0.5, 'Unique', true, ...
    'Method','Exhaustive','MatchThreshold',10);
...
[F, inliersIndex] = estimateFundamentalMatrix(matchedPoints1, matchedPoints2, ...
    'Method', 'RANSAC', 'NumTrials', 20000, 'DistanceThreshold', 1e-2);
...
relPose = estrelpose(E,cameraParams.Intrinsics,inlierPoints1,inlierPoints2);
