...
positions_in_degrees    = list(range(135, 226, 3))  # Degrees from 135 to 225 inclusive
...
desired_velocity = 0  # Adjust according to your needs
...
with open(filename, mode='w', newline='') as file:
    ...
    try:
        for position_dxl2 in positions_in_units:
            ...
            time.sleep(0)  # Small delay to allow movement
